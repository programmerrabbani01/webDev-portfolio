import { BaseInfo } from "@/Data/data.ts";
...
export default function Hero() {
  return (
    <>
      <div id="hero" className="w-full pt-[4vh] md:pt-[12vh] h-screen bg-[#0f0715] overflow-hidden relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            ...
            <div className="">
              ...
              <h1
                data-aos="fade-right"
                data-aos-delay="100"
                className="text_bg text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[4rem] text-white"
              >
                {BaseInfo.position}
              </h1>
              {/* description */}
